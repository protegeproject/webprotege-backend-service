...
import static edu.stanford.bmir.protege.web.server.frame.PlainPropertyAnnotationValue.PROPERTY_ANNOTATION_VALUE;
import static edu.stanford.bmir.protege.web.server.frame.PlainPropertyClassValue.PROPERTY_CLASS_VALUE;
import static edu.stanford.bmir.protege.web.server.frame.PlainPropertyDatatypeValue.PROPERTY_DATATYPE_VALUE;
import static edu.stanford.bmir.protege.web.server.frame.PlainPropertyIndividualValue.PROPERTY_INDIVIDUAL_VALUE;
import static edu.stanford.bmir.protege.web.server.frame.PlainPropertyLiteralValue.PROPERTY_LITERAL_VALUE;
