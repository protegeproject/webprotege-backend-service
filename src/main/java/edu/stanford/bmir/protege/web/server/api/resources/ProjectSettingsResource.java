...
import edu.stanford.bmir.protege.web.server.crud.GetEntityCrudKitSettingsAction;
import edu.stanford.bmir.protege.web.server.crud.IRIPrefixUpdateStrategy;
import edu.stanford.bmir.protege.web.server.crud.SetEntityCrudKitSettingsAction;
import edu.stanford.bmir.protege.web.server.project.GetProjectPrefixDeclarationsAction;
import edu.stanford.bmir.protege.web.server.project.ProjectId;
import edu.stanford.bmir.protege.web.server.project.SetProjectPrefixDeclarationsAction;
import edu.stanford.bmir.protege.web.server.projectsettings.AllProjectSettings;
...
import edu.stanford.bmir.protege.web.server.tag.SetProjectTagsAction;
import edu.stanford.bmir.protege.web.server.tag.TagData;
