 ...
 * </p>
 * <p>
 *     If the upload succeeds then the webprotege returns an HTTP 201 response (indicating that a new resource was created
 *     on the webprotege) and the body of the response consists of the name of the file resource.  The upload will fail if
 *     the content encoding is not multi-part. In this case, the webprotege will return an HTTP 400 response code
 *     (indicating that the request was not well formed).  If the file could not be created on the webprotege for what ever
 *     reason, the webprotege will return an HTTP 500 response code (internal webprotege error) and the body of the response
...
public class FileUploadServlet extends HttpServlet {
    ...
    /**
     * Creates a fresh file on the webprotege.
     * @return The file.
