...
import edu.stanford.protege.webprotege.annotations.WebProtegePropertiesDocumentation;
 ...
 * or required.  Required properties must have a value specified in the webprotege size webprotege.properties file.
...
public enum WebProtegePropertyName {
    ...
    @WebProtegePropertiesDocumentation(description = "The host name of the mongodb webprotege", example = "localhost")
    MONGO_DB_HOST("mongodb.host", PropertyValue.ofString("localhost")),

    @WebProtegePropertiesDocumentation(description = "The port number of the mongodb webprotege", example = "27017")
