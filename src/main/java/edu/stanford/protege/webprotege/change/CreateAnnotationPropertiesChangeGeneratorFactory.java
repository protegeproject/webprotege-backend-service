...
public final class CreateAnnotationPropertiesChangeGeneratorFactory {
  ...
  @Inject
  public CreateAnnotationPropertiesChangeGeneratorFactory(
  ...
  public CreateAnnotationPropertiesChangeGenerator create(
      String sourceText, String langTag, ImmutableSet<OWLAnnotationProperty> parents) {
    return new CreateAnnotationPropertiesChangeGenerator(
